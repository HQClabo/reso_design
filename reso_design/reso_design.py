...
class Junction:
    ...
    def print(self):
        ...
        print(f"EJ = {self.EJ/h*1e-9:.3f} GHz")
        print(f"EC = {self.Ec/h*1e-9:.3f} GHz")
...
class JJArrayDolan(Junction):
    ...
    def print(self):
        ...
        print(f"Kerr resonator = K/N^2 = {self.Kerr_resonator/h*1e-3:.0f} kHz")
